...
def parse_args(args):
    ...
    parser.add_argument('--lr_range_test', type=bool, default=True, help="Run learning rate range test")
    parser.add_argument('--epochs', type=int, default=5, help="Number of training epochs")
    parser.add_argument('--samples_per_epoch', type=int, default=50, help="Number of  training samples per epoch")
...
def load_data(args):
    ...
    X_train, X_valid, y_train, y_valid = train_test_split(X, y, test_size=0.5, random_state=0, shuffle=True)
...
def main(args=None):
    ...
    if args.lr_range_test:
        # run LR range test
        cnn.run_lr_finder(*data, args.batch_size, args.epochs, args.samples_per_epoch)
