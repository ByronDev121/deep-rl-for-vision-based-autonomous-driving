...
class BatchGenerator:
    ...
    @staticmethod
    def y2indicator(steering_angle, steering_angles):
        maximum = max(steering_angles)
    ...
    def batch_generator(self, image_paths, steering_angles, batch_size, train):
        """
        Generate training image give image paths and associated steering angles
        """

        image_paths = image_paths[:14574]
        steering_angles = steering_angles[:14574]
        ...
        while True:
            ...
            for index in np.random.permutation(image_paths.shape[0]):
                ...
                if self.do_augmentation and train:
                ...
                # steers[i] = BatchGenerator.y2indicator(steering_angle, steering_angles)
                i += 1
                if i == batch_size:
                    break
