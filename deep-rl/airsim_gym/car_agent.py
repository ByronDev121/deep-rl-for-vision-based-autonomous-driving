...
import airsim
from airsim import CarClient, CarControls, ImageRequest, ImageType, Pose, Vector3r, Quaternionr
...
class CarAgent(CarClient):
    ...
    def __init__(self):
        ...
        self.kf = KalmanFilter1D(estimate_variance=1, measurement_variance=0.3)
